package cn.it.xiaodongbei.springframework.beans.factory.xml;
...
import cn.it.xiaodongbei.springframework.beans.factory.support.AbstractBeanDefinitionReader;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException {
        ...
        for (int i=0;i<childNodes.getLength();i++){
            ...
            String intiMethod = bean.getAttribute("init-method");
            String destroyMethodName = bean.getAttribute("destory-method");
            ...
            beanDefinition.setInitMethodName(intiMethod);
